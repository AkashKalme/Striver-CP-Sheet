...
void solve()
{
    string s, e;
    cin >> s >> e;
    int shours = (s[0] - '0') * 10 + (s[1] - '0');
    int sminutes = (s[3] - '0') * 10 + (s[4] - '0');
    int ehours = (e[0] - '0') * 10 + (e[1] - '0');
    int eminutes = (e[3] - '0') * 10 + (e[4] - '0');
    int t1 = shours * 60 + sminutes;
    int t2 = ehours * 60 + eminutes;
    int t3 = (t1 + t2) / 2;
    cout << setfill('0') << setw(2) << t3 / 60 << ":"
         << setfill('0') << setw(2) << t3 % 60 << "\n";
}
